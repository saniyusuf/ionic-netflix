...
/*
  Generated class for the Film provider.
  ...
  private films = [
    {
      ...
      "Type": "movie",
      "Response": true,
      "Preview": "https://i.giphy.com/l0MYPWNTX1mgHSI1i.gif",
      "Featured": true,
      "FeaturedImage": "https://adindasrblog.files.wordpress.com/2016/12/fantastic-beasts-and-where-to-find-them-high-quality-wallpapers.jpg"
    },
    {
      ...
      "Type": "movie",
      "Response": true,
      "Preview": "https://i.giphy.com/l0MYGkOTBs7uA73Rm.gif",
      "Featured": true,
      "FeaturedImage": "https://www.allinmam.com/wp-content/uploads/2016/04/the-jungle-book-3d.jpg"
    },
    {
      "Title": "Suicide Squad",
      "Year": "2016",
      ...
      "Response": true,
      "Trending": true,
      "Preview": "https://i.giphy.com/3oz8xDX2GcLQOw64AE.gif"
    },
    {
      ...
      "Response": true,
      "Trending": true,
      "Preview": "https://i.giphy.com/l4Jz8OoCym22Z0mre.gif"
    },
    {
      "Title": "Ghostbusters",
      "Year": "2016",
      ...
      "Response": true,
      "Trending": true,
      "Preview": "https://i.giphy.com/l4JzcYMeQrv1BG8Io.gif"
    },
    {
      ...
      "Response": true,
      "Trending": true,
      "Preview": "https://i.giphy.com/26gJAmgrF2dTHplmg.gif"
    },
    {
      ...
      "Response": true,
      "TopPick": true,
      "Preview": "https://i.giphy.com/3o7TKyx6EIbTiPkX6g.gif"
    },
    {
      "Title": "High Strung",
      "Year": "2016",
      ...
      "Response": true,
      "TopPick": true,
      "Preview": "https://i.giphy.com/26FLcGb1WNLyiOvF6.gif"
    },
    {
      ...
      "Response": true,
      "TopPick": true,
      "Preview": "https://i.giphy.com/l0MYGtTuNxpUEi6Gc.gif"
    },
    {
      ...
      "Response": true,
      "TopPick": true,
      "Preview": "https://i.giphy.com/l0MYsBgwjOBP0KdKU.gif"
    },
    {
      "Title": "Arrival",
      "Year": "2016",
      ...
      "Type": "movie",
      "Response": true,
      "Preview": "https://i.giphy.com/26FLgufmHd6dzUaRO.gif",
      "Featured": true,
      "FeaturedImage": "https://indiewire.com/wp-content/uploads/2016/11/arrival-soundtrack.jpg?w=780"
    }
  ];

  constructor(public db: Database, private http: Http) {
    this.db.connect();
  }

  // getFilms(){
  //   return this.db.collection('films').fetch();
  // }

  getFilms(){
    return this.http.get('https://api.myjson.com/bins/l161h');
  }
